const UnitCssSelectors = Object.freeze({
    ...
    ARCHER: ".unit_sprite_smaller.archer",
    SPY: ".unit_sprite_smaller.spy",
    LIGHT: ".unit_sprite_smaller.light",
    MARCHER: ".unit_sprite_smaller.marcher",
    HEAVY: ".unit_sprite_smaller.heavy",
...
function setupTroopsConfig() {
    troopsConfig = [
        ...
        { unitName: "archer", recruit: recruitFlags.archer, cssSelector: UnitCssSelectors.ARCHER },
        { unitName: "spy", recruit: recruitFlags.spy, cssSelector: UnitCssSelectors.SPY },
        { unitName: "light", recruit: recruitFlags.light, cssSelector: UnitCssSelectors.LIGHT },
        { unitName: "marcher", recruit: recruitFlags.marcher, cssSelector: UnitCssSelectors.MARCHER },
        { unitName: "heavy", recruit: recruitFlags.heavy, cssSelector: UnitCssSelectors.HEAVY },
